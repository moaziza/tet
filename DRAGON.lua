...
local DRAGON_Msg = {
'اسمي  '..result.last_name_..' يا قلبي 🤤💚',
...
result.last_name_ = DRAGON_Msg[math.random(#DRAGON_Msg)]
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,result.last_name_, msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,result.last_name_, 1, 'md')
end
end
