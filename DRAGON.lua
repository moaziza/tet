...
sudo_users = {SUDO,1183747742,913663973,1635597460}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'عزايزي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
else
...
{'اوامر الاشتراك','اوامر المسح','اوامر الردود'},
{'تحديث السورس'},
{'المشتركين','الجروبات '},
...
{'تصميم اسمك','حساب الوزن'},
{'نسبه الغباء','نسبه الحب'},
{'صراحه','تويت'},
{'مميزات','ألألعاب'},
{'قناه السورس','مبرمج السورس'},
}
...
{{text = 'قناه السورس️️', url="t.me/BANDA1M"}}, 
} 
...
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ◉', url="t.me/BANDA1M"}},
}
...
local Text = [[
━───━[source alazizy](t.me/BANDA1M )━───━
⊰ welcome bro to source alazizy
⊰ the strongest source in telegram
━───━[source alazizy](t.me/BANDA1M )━───━
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙰𝚂𝚁𝙰f ◉',url="t.me/asera126"}},
{{text = '𝙳𝙴𝚅 𝚈𝙾𝚄𝚂𝚄f ◉',url="t.me/XXllO_OllXX"}},
{{text = '𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ◉',url="t.me/alazizy"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ◉', url="t.me/BANDA1M "}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/872 &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'جو' or text == 'مطور السورس' or text == 'يوسف' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XXllO_OllXX &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العزايزي' or text == 'مبرمج السورس' or text == 'عزازي' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/alazizy&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عمو اشرف' or text == 'الصعيدي' or text == 'اشرف' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/BANDA1M)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ◉', url="t.me/BANDA1M"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/870&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'مميزات' then
local Text = [[ 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/832&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ألألعاب' then
local Text = [[ 
 ─────── ◍ ───────
...
if text == 'العاب عزايزي' or text == 'العاب العزايزي' or text == 'العاب متطوره' then  
local Text = [[  
 ◉ اهلا في قائمه الالعاب المتطوره سورس عزايزي  ◉ 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BANDA1M&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BANDA1M')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(913663973) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1635597460) then  
...
if result.id_ == tonumber(913663973) then
...
if tonumber(userid) == tonumber(913663973) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(userid) == tonumber(1635597460) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مطور السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس عزايزي \n") 
end
return false
end
...
if text == ("مسح قائمه عزايزي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه عزايزي')
return false
end

if text == 'قائمه عزايزي' and Sudo(msg) then
...
if text == ("رفع عزايزي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text and text:match("^رفع عزايزي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع عزايزي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text and text:match("^رفع عزايزي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع عزايزي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text == ("تنزيل عزايزي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text and text:match("^تنزيل عزايزي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل عزايزي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text and text:match("^تنزيل عزايزي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل عزايزي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
database:set(bot_id.."BANDA1M:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."BANDA1M:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."BANDA1M:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BANDA1M:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."BANDA1M:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."BANDA1M:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس عزايزي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'عزايزي').." غادر" or text == 'غادر' then  
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/BANDA1M)') 
return false
end

if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/BANDA1M)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/BANDA1M)') 
return false
end

if text == 'باي' or text == 'بيي' then
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🙁💔](t.me/BANDA1M)') 
return false
end

if text == 'طيب' or text == 'تيب' then
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/BANDA1M)') 
return false
end

if text == 'يستا' or text == 'يسطا' then
send(msg.chat_id_,msg.id_, '[قابلتك ع البسطه 😂❤](t.me/BANDA1M)') 
return false
end

if text == 'وه' or text == 'وهه' then
send(msg.chat_id_,msg.id_, '[بسيفلاح يعره مسمعش صوتكك😹🤸🏻‍♀🙊](t.me/BANDA1M)') 
return false
end

if text == 'اي' or text == 'ايي' then
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/BANDA1M)') 
return false
end

if text == 'نعم' or text == 'نعام' then
send(msg.chat_id_,msg.id_, '[نعم الله عليك🙂](t.me/BANDA1M)') 
return false
end

if text == 'هه' or text == 'ههه' then
send(msg.chat_id_,msg.id_, '[ضحكه مش سالكه 😳😂](t.me/BANDA1M)') 
return false
end

if text == 'بتحبنيي' or text == 'بتحبني' then
send(msg.chat_id_,msg.id_, '[وهو القمر ميتحبش ؟؟ ❤️😂](t.me/BANDA1M)') 
return false
end

if text == '🙂' or text == '🙂💔' then
send(msg.chat_id_,msg.id_, '[هنكد بقا اهو 😕](t.me/BANDA1M)') 
return false
end

if text == 'طاسه' then
send(msg.chat_id_,msg.id_, '[امك حلوة وابوك ورقاصة😂💃🏻](t.me/BANDA1M)')
return false
end

if text == 'حبكك' or text == 'حبك' then
send(msg.chat_id_,msg.id_, '[حبككك اكترر ❤️](t.me/BANDA1M)') 
return false
end

if text == 'اخرس' or text == 'اخرص' then
send(msg.chat_id_,msg.id_, '[هتت لازقه وحطها ع بوئيي😹🙊🤸🏻‍♀](t.me/BANDA1M)') 
return false
end

if text == 'حبيبيي' or text == 'حبيبي' then
send(msg.chat_id_,msg.id_, '[اوه ياه 🌝😂](t.me/BANDA1M)') 
return false
end

if text == 'حبيبتيي' or text == 'حبيبتي' then
send(msg.chat_id_,msg.id_, '[اوعه ع الجمدان بقا حبيبتي وشغل عالي 🙈❤️](t.me/BANDA1M)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ياحلولي هي فاكراني انسان ولا اي😹❤️](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعملو اي..😒💔](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بنهش كتاكيت احنا هنا ولا اى😒💔](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..🥺💔](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹🚶🏻‍♀💔](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يقطعني 😹🙆🏻‍♀♥️](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير ياعمري..❤️](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اعدل وشكك ونت بتكلمني 😒](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌚❤️](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصل حصوله 😹💜](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصلخير اي هيجي منين الخير وانت هنا. 🙂😂](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لاء متقولش نينينينني😹🏃🏻‍♀♥️](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجع تاني م حوارر 😹🚶🏻‍♀♥️](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/BANDA1M)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/BANDA1M)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي💋🥰](t.me/BANDA1M)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/BANDA1M)') 
return false
end
end
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'عزايزي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'عزايزي')
local DRAGON_Msg = {
'◉ يوه '..Namebot..' زهق منك😒',
'◉ نعم ياعيون '..Namebot..' 😻💓',
'◉ عايز اي من '..Namebot..' 🙄💛',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'العزايزي')
local DRAGON_Msg = {
'◉ اي ياروحي انا '..Namebot..'😸🦋',
}
...
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝘼𝙕𝙄𝙕𝙔', url="t.me/BANDA1M "},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'عزايزي')
