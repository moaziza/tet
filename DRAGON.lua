...
elseif text and text:match('(.*)/unlockchat') and msg.reply_to_message_id_ == 0 and Mod(msg) then 
if tonumber(text:match('(.*)/unlockchat')) == tonumber(data.sender_user_id_) then
...
if text == '/lock:text' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
