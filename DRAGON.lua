...
تم تطوير وبرمجه السورس بواسطه مصطفي تايجر
...
sudo_users = {SUDO,1838217063,1889307769,1576116142,1691222037,1844327092,1183747742}   
...
var = true
elseif tonumber(user_id) == tonumber(1889307769) then
var = true
elseif tonumber(user_id) == tonumber(1576116142) then
var = true
elseif tonumber(user_id) == tonumber(1691222037) then
var = true
elseif tonumber(user_id) == tonumber(1838217063) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'تايجر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "NED_Black2")
...
local NED_Black2 = database:get(bot_id..'text:ch:user')
if NED_Black2 then
send(msg.chat_id_, msg.id_,'['..NED_Black2..']')
else
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/NED_Black2)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/NED_Black2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n⋆ العضو ⤌ ['..result.title_..'](t.me/'..(username or 'NED_Black2')..')'
status  = '\n⋆ تم ترقيته مطور'
...
usertext = '\n⋆ العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'NED_Black2')..')'
status  = '\n⋆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⋆ العضو ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'NED_Black2')..') \n⋆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⋆ العضو : {["..data.first_name_.."](T.ME/NED_Black2)}\n⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⋆ عذرا ⤌ {["..data.first_name_.."](T.ME/NED_Black2)}\n⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/NED_Black2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙶𝙴𝚁𝚂](t.me/NED_Black2) ⁞ 💘

♲━┅┄⟞⟦𝐓𝐄𝐆𝐄𝐑𝐒⟧⟝┄┉━♲
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚍𝚎𝚟 𝚋𝚕𝚊𝚌𝚔 ',url="t.me/rageey90"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/NED_Black2"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/910 &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بلاك' or text == 'يابلاك' or text == 'مبرمج السورس' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/909&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'العزايزي' or text == 'ياعزايزي' or text == 'عزايزي' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[ها هو بوت التواصل يحبيب قلبي..🥺♥️](t.me/rageey909_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بوت التواصل',url="t.me/rageey909_bot"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/910 &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '00:00',url="t.me/NED_Black2"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/910 &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ 𝙲𝙷 - [𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻](t.me/NED_Black2) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/906&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'NED_Black2')..') \n⋆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NED_Black2')..') \n⋆ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n⋆تم قفل البوتات بالطرد\n⋆تم وضع الايدي بدون صوره\n⋆تم قفل التكرار بالطرد\n⋆تم قفل الروابط\n⋆تم قفل التوجيه\n⋆تم قفل الملصقات\n⋆تم قفل المتحركه\n⋆تم قفل الفيديو\n⋆تم قفل السب\n⋆تم قفل التعديل\n⋆تم قفل الفارسيه\n⋆تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ⤌[ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'NED_Black2')..')')   
end,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1838217063) then  
...
if tonumber(result.sender_user_id_) == tonumber(1889307769) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم مطـور السـورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1576116142) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر صـاحبه السـورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1691222037) then  
...
if result.id_ == tonumber(1838217063) then
...
if result.id_ == tonumber(1889307769) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مطـور السـورس عام")
return false 
end
if result.id_ == tonumber(1576116142) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر صـاحبه السـورس عام")
return false 
end
...
if result.id_ == tonumber(1691222037) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مالك السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1838217063) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1889307769) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مطـور السـورس عام")
return false 
end
if tonumber(userid) == tonumber(1576116142) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر صـاحبه السـورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1691222037) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مالك السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1576116142) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم صـاحبه السـورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1844327092) then  
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⋆ لعضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'NED_Black2')..')'
status  = '\n⋆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⋆ العضو ⤌ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋆ العضــو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'NED_Black2')..')'
...
' }\n'..'⋆  الايدي بالصوره ⤌ { '..idph..
' }\n'..'⋆  الرفع ⤌ { '..setadd..
' }\n'..'⋆  الحظر ⤌ { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n⋆ قناة سورس تايجر ↓\n [ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻](t.me/NED_Black2) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⋆ العضو ⤌ ['..result.title_..'](t.me/'..(text1[3] or 'NED_Black2')..')'..'\n⋆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}   
keyboard.inline_keyboard = {  
 {{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝙰𝚁𝙸𝚂》', url="t.me/NED_Black2"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
database:set(bot_id.."NED_Black2:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⋆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."NED_Black2:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."NED_Black2:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس تايجر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'NED_Black2')..')'
local iduser = result.sender_user_id_
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ اليك الاوامر الخاص بسورس تايجر .
