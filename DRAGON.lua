...
sudo_users = {SUDO,1236115319,1706080513,1124610301}   
...
var = true
elseif tonumber(user_id) == tonumber(1706080513) then
var = true
...
if text and text:match("^(.*)/unlockchat") then
...
local Text = [[
◤━───━[𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝘼𝙕𝙄𝙕𝙔](t.me/UU_Le2)━───━◥
𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑼𝑺𝑳𝑰𝑴
𝑻𝑯𝑬 𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑻 𝑺𝑶𝑼𝑹𝑪𝑬 𝑰𝑵 𝑻𝑬𝑳𝑬𝑮𝑹𝑨𝑴 
◣━───━[𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝘼𝙕𝙄𝙕𝙔](t.me/UU_Le2)━───━◢
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨  L E G A N D ◉   ❩ ',url="t.me/L120N"}},
{{text = '  ❨  M U S L I M ◉   ❩ ',url="t.me/UU_bh"}},
...
if text == 'مسلم' or text == 'مالك السورس' or text == 'سمير' then
local Text = [[
المالك مسلم لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MS_bh1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب مسلم' or text == 'العاب المسلم' or text == 'العاب متطوره' then  
local Text = [[  
...
for k,v in pairs(list) do
local username = database:get(bot_id.."DRAGON:User:Name" .. v)
if username then
...
if text == ("رفع قطتي") or text == ("رفع بسبس") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then
...
send(msg.chat_id_,msg.id_, '[هنكد بقا اهو 😕](t.me/UU_Le2)') 
return false
end
...
if text == 'اخرس' or text == 'اخرص' then
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/UU_Le2)') 
return false
end
end
end
...
if linkgpp.ok == true then 
local Teext = '◉'..ta.title_..'\n'..linkgpp.result 
local inline = {{{text = '  ❨  L E G A N D ◉   ❩ ',url="t.me/L120N"}},} 
send_inline_key(msg.chat_id_,Teext,nil,inline,msg.id_/2097152/0.5) 
else 
...
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n🇧🇱-𝒖𝒔𝒆𝒓   '..username..'\n 🇧🇱-𝒎𝒔𝒈𝒔  '..Msguser..'\n ??🇱-𝒔??𝒂𝒕𝒔  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 🇧🇱-𝒊𝒅 '..msg.sender_user_id_..'\n🇧🇱- 𝗖𝗛  @UU_Le2\n')
else
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'◍ هذا الامر خاص بي  الادمن ، المطور الاساسي ، المدير ، المطور الثانوي  ، المطور ، المدير عام ، الادمن العام ، المنشئ')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local UU_Le2 = database:get(bot_id..'text:ch:user')
...
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝘼𝙕𝙄𝙕𝙔', url="t.me/UU_Le2"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == "بوسها" or text == "بوسه" or text == "هات بوسه" or text == "هاتي بوسه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
var = true  
elseif database:sismember(bot_id.."DRAGON:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."DRAGON:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."DRAGON:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."DRAGON:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."DRAGON:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."DRAGON:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
elseif tonumber(user_id) == tonumber(1635597460) then  
var = "المبرمج اشرف "
elseif DevDRAGONe(user_id) == true then
var = "المطور الاساسي"  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
var = "المطور الاساسي²"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."DRAGON:Sudo:User", user_id) then
var = database:get(bot_id.."DRAGON:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."DRAGON:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."DRAGON:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."DRAGON:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."DRAGON:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."DRAGON:Manager"..chat_id, user_id) then
var = database:get(bot_id.."DRAGON:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."DRAGON:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."DRAGON:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."DRAGON:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."DRAGON:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."DRAGON:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."DRAGON:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."DRAGON:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."DRAGON:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."DRAGON:GBan:User",User_id) then
Var = true
else
Var = false
end
...
for DRAGON in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = DRAGON
end
local NameUser = "◍ بواسطه - ["..data.first_name_.."](T.me/"..UserName..")"
...
vardump(groups)  
for idg,v in pairs(groups.GP_BOT) do
database:sadd(bot_id..'DRAGON:Chek:Groups',idg) 
database:set(bot_id.."DRAGON:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'DRAGON:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."DRAGON:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."DRAGON:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."DRAGON:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."DRAGON:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."DRAGON:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
if type == "keed" then
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function DRAGON_Files(msg)
for v in io.popen('ls DRAGON_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("DRAGON_Files/"..v)
if plugin.DRAGON and msg then
pre_msg = plugin.DRAGON(msg)
end
end
...
function DRAGON_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local id = tostring(msg.chat_id_)
if id:match("-100(%d+)") then
database:incr(bot_id..'DRAGON:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'DRAGON:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."DRAGON:DRAGON:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه") 
database:del(bot_id.."DRAGON:DRAGON:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."DRAGON:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'DRAGON:Msg:Pin:Chat'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
for k,v in pairs(list) do 
sendPhoto(v, 0, photo,(msg.content_.caption_ or ""))
database:set(bot_id..'DRAGON:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'DRAGON:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'DRAGON:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."DRAGON:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."DRAGON:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."DRAGON:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."DRAGON:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."DRAGON:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."DRAGON:Lock:AddMempar"..msg.chat_id_) == "kick" then
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
...
if database:get(bot_id.."DRAGON:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("@[%a%d_]+") or msg.content_.caption_:match("@(.+)") then  
if database:get(bot_id.."DRAGON:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."DRAGON:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."DRAGON:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") or msg.content_.caption_:match(".[Pp][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or msg.content_.caption_:match("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]/") or msg.content_.caption_:match("[Tt].[Mm][Ee]/") then 
if database:get(bot_id.."DRAGON:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."DRAGON:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."DRAGON:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."DRAGON:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."DRAGON:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."DRAGON:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.entities_[0] and msg.content_.entities_[0].ID == "MessageEntityUrl" or msg.content_.entities_[0].ID == "MessageEntityTextUrl" then      
if not Vips(msg) then
if database:get(bot_id.."DRAGON:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."DRAGON:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."DRAGON:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
local _nl, real_ = string.gsub(text, "%d", "")   
sens = 400  
if database:get(bot_id.."DRAGON:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."DRAGON:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."DRAGON:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."DRAGON:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."DRAGON:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."DRAGON:Get:Welcome:Group"..msg.chat_id_)  
if GetWelcomeGroup then 
t = GetWelcomeGroup
else  
t = "\n• نورت حبي \n•  name \n• user" 
...
database:set(bot_id.."DRAGON:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."DRAGON:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."DRAGON:lockpin"..msg.chat_id_) then
...
------------------------------------------------------
if msg.content_.photo_ then  
if database:get(bot_id.."DRAGON:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
if msg.content_.photo_.sizes_[3] then  
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_ 
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_ 
...
database:del(bot_id.."DRAGON:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."DRAGON:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◍ تم الغاء وضع الوصف") 
database:del(bot_id.."DRAGON:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."DRAGON:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request("https://api.telegram.org/bot"..token.."/setChatDescription?chat_id="..msg.chat_id_.."&description="..text) 
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."DRAGON:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◍ تم الغاء حفظ الترحيب") 
database:del(bot_id.."DRAGON:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."DRAGON:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."DRAGON:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"◍ تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."DRAGON:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"◍ تم الغاء حفظ الرابط")       
database:del(bot_id.."DRAGON:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."DRAGON:Private:Group:Link"..msg.chat_id_,Link)
send(msg.chat_id_,msg.id_,"◍ تم حفظ الرابط بنجاح")       
database:del(bot_id.."DRAGON:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
...
if database:get(bot_id.."DRAGON:DRAGON:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه للخاص") 
database:del(bot_id.."DRAGON:DRAGON:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'DRAGON:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."DRAGON:DRAGON:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه") 
database:del(bot_id.."DRAGON:DRAGON:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."DRAGON:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."DRAGON:DRAGON:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه") 
database:del(bot_id.."DRAGON:DRAGON:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."DRAGON:Chek:Groups")   
...
if database:get(bot_id.."DRAGON:DRAGON:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء الاذاعه") 
database:del(bot_id.."DRAGON:DRAGON:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."DRAGON:UsersBot")   
...
local DRAGON_Msg = database:get(bot_id.."DRAGON:Add:Filter:Rp2"..text..msg.chat_id_)   
if DRAGON_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","◍ "..DRAGON_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."DRAGON:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ◍" then   
send(msg.chat_id_, msg.id_,"◍ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."DRAGON:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."DRAGON:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."DRAGON:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "◍ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."DRAGON:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."DRAGON:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◍ ارسل الامر الجديد")  
database:del(bot_id.."DRAGON:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."DRAGON:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."DRAGON:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."DRAGON:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."DRAGON:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."DRAGON:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◍ تم حفظ الامر")  
database:del(bot_id.."DRAGON:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'DRAGON:Num:Add:Bot') or 0) and not DevDRAGON(msg) then
send(msg.chat_id_, msg.id_,'◍ عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'DRAGON:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'DRAGON:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'◍ المجموعه مفعله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','◍ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'DRAGON:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NameChat = chat.title_
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'DRAGON:Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'◍ المجموعه معطله سابقا ')
else
Reply_Status(msg,result.id_,'reply_Add','◍ تم تعطيل المجموعه ~ '..chat.title_..'')
database:srem(bot_id..'DRAGON:Chek:Groups',msg.chat_id_)  
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
NameChat = NameChat:gsub('"',"") 
...
database:set(bot_id.."DRAGON:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'DRAGON:Free:Add:Bots') then 
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'◍ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
Reply_Status(msg,result.id_,'reply_Add','◍ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'DRAGON:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'DRAGON:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'DRAGON:Start:Time'..msg.sender_user_id_) then
local start = database:get(bot_id.."Start:Bot")  
if start then 
Test = start
else
...
database:setex(bot_id..'DRAGON:Start:Time'..msg.sender_user_id_,60,true)
return false
end
...
if text =='الاحصائيات ◍' then
local Groups = database:scard(bot_id..'DRAGON:Chek:Groups')  
local Users = database:scard(bot_id..'DRAGON:UsersBot')  
send(msg.chat_id_, msg.id_,'◍ احصائيات البوت \n\n◍ عدد المجموعات *~ '..Groups..'\n◍ عدد المشتركين ~ '..Users..'*')
end
if text == "مسح المشتركين ◍" then
local pv = database:smembers(bot_id..'DRAGON:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'DRAGON:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = database:smembers(bot_id..'DRAGON:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]
...
database:srem(bot_id..'DRAGON:Chek:Groups',group[i])  
w = w + 1
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'DRAGON:Chek:Groups',group[i])  
...
database:del(bot_id..'DRAGON:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'\n◍ تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي ◍' then
database:set(bot_id..'DRAGON:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'\n◍ تم تعطيل البوت الخدمي') 
end
if text=="اذاعه خاص ◍" and msg.reply_to_message_id_ == 0 then
if database:get(bot_id.."DRAGON:Status:Bc") and not DevBOYKAW(msg) then 
send(msg.chat_id_, msg.id_,"◍ الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."DRAGON:DRAGON:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."DRAGON:DRAGON:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◍ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n◍ للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."DRAGON:DRAGON:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◍ ارسل لي التوجيه الان") 
return false
end 
...
database:setex(bot_id.."DRAGON:DRAGON:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◍ ارسل لي التوجيه الان") 
return false
end 
if text == "تفعيل الاذاعه ◍" then
database:del(bot_id.."DRAGON:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n◍ تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه ◍" then
database:set(bot_id.."DRAGON:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n◍ تم تعطيل الاذاعه") 
return false
end 
if text == "تفعيل المغادره ◍" then
database:del(bot_id.."DRAGON:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"◍ تم تفعيل مغادرة البوت") 
return false 
end
if text == "تغير اسم البوت ◍"  then 
if DevBOYKAW(msg) then
database:setex(bot_id.."DRAGON:Set:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"◍ ارسل لي الاسم الان ")  
end
return false
end
if text == "تعطيل المغادره ◍" then
database:set(bot_id.."DRAGON:Left:Bot"..msg.chat_id_,true)   
...
database:del(bot_id.."DRAGON:GBan:User")
send(msg.chat_id_, msg.id_, "\n◍ تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين ◍") and DevBOYKAW(msg) then
database:del(bot_id.."DRAGON:Sudo:User")
send(msg.chat_id_, msg.id_, "\n◍ تم مسح قائمة المطورين  ")
end
if text == ("قائمه العام ◍") and DevBOYKAW(msg) then
local list = database:smembers(bot_id.."DRAGON:GBan:User")
t = "\n◍ قائمة المحظورين عام \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."DRAGON:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."DRAGON:Sudo:User")
t = "\n◍ قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."DRAGON:User:Name" .. v)
if username then
...
for k,v in pairs(list) do   
NAME = 'DRAGON Chat'
ASAS = database:smembers(bot_id.."DRAGON:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."DRAGON:Constructor"..v)
MDER = database:smembers(bot_id.."DRAGON:Manager"..v)
MOD = database:smembers(bot_id.."DRAGON:Mod:User"..v)
link = database:get(bot_id.."DRAGON:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"DRAGON":"'..NAME..'",'
else
t = t..',"'..v..'":{"DRAGON":"'..NAME..'",'
...
download_to_file('https://raw.githubusercontent.com/MahmoudM5/DRAGON/master/DRAGON.lua', 'DRAGON.lua') 
download_to_file('https://raw.githubusercontent.com/MahmoudM5/DRAGON/master/start.lua', 'start.lua') 
dofile('DRAGON.lua')  
return false
end
if text == "تحديث ◍" then
...
database:del(bot_id.."DRAGON:Link_Group"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DRAGON:Chek:Welcome"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DRAGON:Reply:Sudo"..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'DRAGON:Lock:ID:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'DRAGON:Lock:ID:Bot:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DRAGON:Kick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DRAGON:Reply:Manager"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DRAGON:Link_Group"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DRAGON:Chek:Welcome"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DRAGON:Reply:Sudo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'DRAGON:Lock:ID:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'DRAGON:Lock:ID:Bot:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DRAGON:Kick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."DRAGON:Reply:Manager"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."DRAGON:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:User:Name"..Chat_id,"del") 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Sticker"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Animation"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Video"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Photo"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Audio"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:vico"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Document"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Contact"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Spam"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hset(bot_id.."DRAGON:flooding:settings:"..Chat_id ,"flood","del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."DRAGON:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:AddMempar"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:text"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Join"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Bot:kick"..Chat_id)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:edit"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Link"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Spam"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hdel(bot_id.."DRAGON:flooding:settings:"..Chat_id ,"flood")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."DRAGON:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه ◍', callback_data=data.sender_user_id_.."/homelocks"},
...
if data.ID == "UpdateChannel" then 
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
database:srem(bot_id..'DRAGON:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
database:del(bot_id..'DRAGON:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل تحقق' ) 
end
if text == 'تفعيل تحقق' and Addictive(msg) then  
database:set(bot_id..'DRAGON:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\nتم تفعيل تحقق' ) 
end 

if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'DRAGON:nwe:mem:group'..msg.chat_id_) == 'true'then
numphoto = {'3','8','9','6'}
...
if database:get(bot_id.."DRAGON:Lock:tagservr"..msg.chat_id_) then  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false
end    
end   
if text and not database:sismember(bot_id..'DRAGON:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'DRAGON:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'DRAGON:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."DRAGON:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."DRAGON:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."DRAGON:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."DRAGON:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."DRAGON:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."DRAGON:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."DRAGON:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."DRAGON:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."DRAGON:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."DRAGON:Name:Bot") or "العزايزي")
if not database:get(bot_id.."DRAGON:Fun_Bots"..msg.chat_id_) then
