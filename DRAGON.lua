...
sudo_users = {SUDO,1236115319,1797771210}   
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/L_E_p&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
 🕊 اهلا بك في سورس مسلم الجمدان يروحي  🕊 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ L E G A N D 🕊  ❩ ',url="t.me/L_E_p"}},
...
local Text = [[
 🕊 اهلا بك في سورس مسلم الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  🕊 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ L E G A N D 🕊  ❩ ',url="t.me/L_E_p"}},
...
if text == 'ليجاند' or text == 'Legand' or text == 'legand' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍𝒎𝒖𝒔𝒍𝒊𝒎.',url="t.me/UU_Le2"}},
}
local msg_id = msg.id_/2097152/0.5
