...
send(msg.sender_user_id_, msg.id_,'◉ تم ارسال رسالـتك للمـطور')
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'عزايزي') 
local DRAGON_Msg = { 
'◉ اي ياروحي اسمي '..Namebot..'💘🐼',
} 
