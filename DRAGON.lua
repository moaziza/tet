...
sudo_users = {SUDO,1183747742,1844327092,1421311181,1238726725,1709783101,1343405656}   
...
var = true
elseif tonumber(user_id) == tonumber(1844327092) then
var = true
elseif tonumber(user_id) == tonumber(1421311181) then
var = true
elseif tonumber(user_id) == tonumber(1238726725) then
var = true
elseif tonumber(user_id) == tonumber(1183747742) then
var = true
elseif tonumber(user_id) == tonumber(1343405656) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'العزايزي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local var = true 
if DevRio:get(TrOn.."DevRio2") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevRio:get(TrOn..'DevRio2')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevRio:get(TrOn..'Rio:textch:user') then
local textchuser = DevRio:get(TrOn..'Rio:textch:user')
send(msg.chat_id_,msg.id_,'['..textchuser..']')
else
send(msg.chat_id_,msg.id_,"⋆ عليك الاشتراك في قناة البوت \n⋆ قناة البوت ⤌ ["..DevRio:get(TrOn..'DevRio3').."]")
end
elseif data.ok then
return var
end
...
if DataText == '/delyes' and DevRio:get(TrOn..'yes'..data.sender_user_id_) == 'delyes' then
DevRio:del(TrOn..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(TrOn..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevRio:get(TrOn..'no'..data.sender_user_id_) == 'delno' then
DevRio:del(TrOn..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(TrOn..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⋆ تم الغاء امر اطردني") 
end
--     Source TrOn     --
if DataText == '/yesdel' and DevRio:get(TrOn..'yesdel'..data.sender_user_id_) == 'delyes' then
DevRio:del(TrOn..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(TrOn..'nodel'..data.sender_user_id_, 'delno')
if DevRio:sismember(TrOn..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(TrOn..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevRio:sismember(TrOn..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(TrOn..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(TrOn..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevRio:sismember(TrOn..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevRio:sismember(TrOn..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(TrOn..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(TrOn..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(TrOn..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(TrOn..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(TrOn..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevRio:srem(TrOn..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(TrOn..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(TrOn..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(TrOn..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(TrOn..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(TrOn..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevRio:get(TrOn.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "⋆ تم الغاء امر تغير المطور الاساسي") 
DevRio:del(TrOn.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevRio:get(TrOn.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevRio:get(TrOn..'nodel'..data.sender_user_id_) == 'delno' then
DevRio:del(TrOn..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(TrOn..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⋆ تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevRio:get(TrOn.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevRio:smembers(TrOn..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevRio:incrby(TrOn..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevRio:del(TrOn..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(TrOn.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "⋆ *صاحب الحظ* ⤌ ["..UserName.."]\n⋆ *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(TrOn..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(TrOn.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevRio:del(TrOn.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝘼𝙕𝙄𝙕𝙔")  
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "العزايزي")
...
local Text =[[
[*«.¸¸.•°˚˚°❃ «.¸¸.•°˚˚°❃«.¸¸.•°˚˚°❃*](t.me/BANDA1M)
⊰ w̶e̶l̶c̶o̶m̶e̶ b̶r̶o̶ t̶o̶ s̶o̶ᵘ̶ r̶c̶e̶ ̶a̶l̶̶a̶z̶i̶z̶y̶-
⊰ t̶h̶e̶ s̶t̶r̶o̶n̶g̶e̶s̶t̶ s̶o̶ᵘ̶ r̶c̶e̶ i̶n̶ t̶e̶l̶e̶g̶r̶̶a̶m̶ 
[*«.¸¸.•°˚˚°❃ «.¸¸.•°˚˚°❃«.¸¸.•°˚˚°❃*](t.me/BANDA1M)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓆩𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝙻𝙰𝚉𝙸𝚉𝚈𓆪', url = "https://t.me/BANDA1M"},
},
{
{text = '𓆩اضف البوت لمجموعتك𓆪', url="http://t.me/"..sudos.UserName.."?startgroup=new"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ⋆', url="t.me/BANDA1M"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mmsst13/903&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب العزايزي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'BANDA1M')..') \n⋆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BANDA1M')..') \n⋆ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1343405656) then  
...
if tonumber(result.sender_user_id_) == tonumber(1238726725) then  
...
if result.id_ == tonumber(1343405656) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(1238726725) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مالك السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1343405656) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1238726725) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مالك السورس عام")
return false 
end
...
if text == ("مسح قائمه العزايزي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n⋆ تم مسح قائمه العزايزي')
return false
end

if text == 'قائمه العزايزي' and Sudo(msg) then
...
if #list == 0 then
t = "⋆ لا يوجد احد في قائمه العزايزي"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع العزايزي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text and text:match("^رفع العزايزي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع العزايزي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text and text:match("^رفع العزايزي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع العزايزي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text == ("تنزيل العزايزي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text and text:match("^تنزيل العزايزي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل العزايزي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
if text and text:match("^تنزيل العزايزي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل العزايزي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local BANDA1M = database:get(bot_id..'text:ch:user')
if BANDA1M then
send(msg.chat_id_, msg.id_,'['..BANDA1M..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋆ العضــو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'BANDA1M')..')'
...
keyboard = {}   
keyboard.inline_keyboard = {  
 {{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝙰𝚁𝙸𝚂》', url="t.me/BANDA1M"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
end --الكود حصري سورس العزايزي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه العزايزي') 
return false
end
...
for k,v in pairs(List) do
local GroupsManagers = DevRio:scard(TrOn.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevRio:scard(TrOn.."Rio:Admins:"..v) or 0
local Groupslink = DevRio:get(TrOn.."Rio:Groups:Links" ..v)
