...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'أوريون'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "SO_UR_SE_AR_EON")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝗦𝗢𝗨𝗥𝗖𝗘 𝗢𝗥𝗜𝗢𝗡")  
...
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
else
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'أوريون') 
local DRAGON_Msg = { 
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/SO_UR_SE_AR_EON)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SO_UR_SE_AR_EON"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n⋆ العضو ↚ ['..result.title_..'](t.me/'..(username or 'SO_UR_SE_AR_EON')..')'
status  = '\n⋆ تم ترقيته مطور'
...
usertext = '\n⋆ العضو ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_UR_SE_AR_EON')..')'
status  = '\n⋆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⋆ العضو ↚ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'SO_UR_SE_AR_EON')..') \n⋆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "أوريون")
...
send(msg.chat_id_,0,"⋆ العضو : {["..data.first_name_.."](T.ME/SO_UR_SE_AR_EON)}\n⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⋆ عذرا ↚ {["..data.first_name_.."](T.ME/SO_UR_SE_AR_EON)}\n⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text =[[
[*«.¸¸.•°˚˚°❃ «.¸¸.•°˚˚°❃«.¸¸.•°˚˚°❃*](t.me/SO_UR_SE_AR_EON)
⊰ w̶e̶l̶c̶o̶m̶e̶ b̶r̶o̶ t̶o̶ s̶o̶ᵘ̶ r̶c̶e̶ d̶n̶d̶ᵘ̶ s̶h̶̶a̶
...
{
{text = '𓆩𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈𓆪', url = "https://t.me/alazizy"},{text = '𓆩𝙳𝙴𝚅 𝚁𝙰𝙷𝙴𝙴𝙼𓆪', url = "https://t.me/K_I_N_G_A_L_B_E_R_T"},
},
{
{text = '𓆩𝙳𝙴𝚅 𝙰𝚂𝙷𝚁𝙰𝙵𓆪', url = "https://t.me/asera126"},{text = '𓆩𝙳𝙴𝚅 𝙾𝙵𝙵𝙻𝙸𝙽𝙴𓆪', url = "https://t.me/X_x_O_F_F_L_I_N_E_x_X"},
},
{
{text = '𓆩𝚂𝙾𝚞𝚁𝙲𝙴 𝙾𝚁𝙸𝙾𝙽𓆪', url = "https://t.me/SO_UR_SE_AR_EON"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mmsst13/902&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس أوريون ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس أوريون ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚞𝚁𝙲𝙴 𝙾𝚁𝙸𝙾𝙽 ⋆', url="t.me/SO_UR_SE_AR_EON"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ 𝘾𝙃 - [𝗦𝗢𝗨𝗥𝗖𝗘 𝗢𝗥𝗜𝗢𝗡](t.me/SO_UR_SE_AR_EON) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب أوريون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ↚ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'SO_UR_SE_AR_EON')..') \n⋆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_UR_SE_AR_EON')..') \n⋆ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n⋆تم قفل البوتات بالطرد\n⋆تم وضع الايدي بدون صوره\n⋆تم قفل التكرار بالطرد\n⋆تم قفل الروابط\n⋆تم قفل التوجيه\n⋆تم قفل الملصقات\n⋆تم قفل المتحركه\n⋆تم قفل الفيديو\n⋆تم قفل السب\n⋆تم قفل التعديل\n⋆تم قفل الفارسيه\n⋆تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ↚[ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'SO_UR_SE_AR_EON')..')')   
end,nil) 
end
...
if Get_info then
local TextS = "\n⋆ اهلا بك في متجر ملفات أوريون\n⋆ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n⋆ علامة تعني { ✔️ } ملف مفعل\n⋆ علامة تعني { x } ملف معطل\n⋆ قناة سورس أوريون ↓\n".."⋆ [اضغط هنا لدخول](t.me/SO_UR_SE_AR_EON) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"⋆ عذرا الملف لايدعم سورس أوريون \n") 
end
return false
end
...
if text == ("مسح قائمه أوريون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n⋆ تم مسح قائمه أوريون')
return false
end

if text == 'قائمه أوريون' and Sudo(msg) then
...
if text == ("رفع أوريون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text and text:match("^رفع أوريون @(.*)$") and Sudo(msg) then
local username = text:match("^رفع أوريون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text and text:match("^رفع أوريون (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع أوريون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text == ("تنزيل أوريون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text and text:match("^تنزيل أوريون @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل أوريون @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text and text:match("^تنزيل أوريون (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل أوريون (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⋆ لعضو ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_UR_SE_AR_EON')..')'
status  = '\n⋆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⋆ العضو ↚ '..userid..''
...
' }\n'..'⋆  الايدي بالصوره ↚ { '..idph..
' }\n'..'⋆  الرفع ↚ { '..setadd..
' }\n'..'⋆  الحظر ↚ { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n⋆ قناة سورس أوريون ↓\n [ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗢𝗥𝗜𝗢𝗡](t.me/SO_UR_SE_AR_EON) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⋆ العضو ↚ ['..result.title_..'](t.me/'..(text1[3] or 'SO_UR_SE_AR_EON')..')'..'\n⋆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}   
keyboard.inline_keyboard = {  
 {{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝙰𝚁𝙸𝚂》', url="t.me/SO_UR_SE_AR_EON"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
database:set(bot_id.."SO_UR_SE_AR_EON:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⋆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SO_UR_SE_AR_EON:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SO_UR_SE_AR_EON:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس أوريون يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'أوريون').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه أوريون') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'أوريون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'أوريون')
local DRAGON_Msg = {
'⋆ يوه '..Namebot..' زهق منك😒',
'⋆ نعم ياعيون '..Namebot..' 😻💓',
'⋆ عايز اي من '..Namebot..' 🙄💛',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_UR_SE_AR_EON')..')'
local iduser = result.sender_user_id_
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ اليك الاوامر الخاص بسورس أوريون .
⋆ اختر الامر الذي تريده من الازرار بلاسفل .
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ ??𝙃 - [𝗦𝗢𝗨𝗥𝗖𝗘 𝗢𝗥𝗜𝗢𝗡 ](t.me/SO_UR_SE_AR_EON )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
