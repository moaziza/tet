...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'دندشه'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "دندشه")
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ⋆', url="t.me/SO_UR_SE_AR_EON"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ 𝘾𝙃 - [𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒](t.me/SO_UR_SE_AR_EON) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب دندشه' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
send(msg.chat_id_, msg.id_,"⋆ عذرا الملف لايدعم سورس دندشه \n") 
end
return false
end
...
if text == ("مسح قائمه دندشه") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n⋆ تم مسح قائمه دندشه')
return false
end

if text == 'قائمه دندشه' and Sudo(msg) then
...
if text == ("رفع دندشه") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text and text:match("^رفع دندشه @(.*)$") and Sudo(msg) then
local username = text:match("^رفع دندشه @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text and text:match("^رفع دندشه (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع دندشه (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text == ("تنزيل دندشه") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text and text:match("^تنزيل دندشه @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل دندشه @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
if text and text:match("^تنزيل دندشه (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل دندشه (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local SO_UR_SE_AR_EON = database:get(bot_id..'text:ch:user')
if SO_UR_SE_AR_EON then
send(msg.chat_id_, msg.id_,'['..SO_UR_SE_AR_EON..']')
...
' }\n'..'⋆  الايدي بالصوره ↚ { '..idph..
' }\n'..'⋆  الرفع ↚ { '..setadd..
' }\n'..'⋆  الحظر ↚ { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n⋆ قناة سورس دندشه ↓\n [ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒](t.me/SO_UR_SE_AR_EON) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
end --الكود حصري سورس دندشه يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'دندشه').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه دندشه') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دندشه').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'دندشه')
local DRAGON_Msg = {
'⋆ يوه '..Namebot..' زهق منك😒',
'⋆ نعم ياعيون '..Namebot..' 😻💓',
'⋆ عايز اي من '..Namebot..' 🙄💛',
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ اليك الاوامر الخاص بسورس دندشه .
