...
if linkgpp.ok == true then 
local Teext = '◉'..ta.title_..'\n'..linkgpp.result 
local inline = {{{text = '  ❨  SＯＵＲＣＥ ◉   ❩ ', url="t.me/BANDA1M "}},} 
send_inline_key(msg.chat_id_,Teext,nil,inline,msg.id_/2097152/0.5) 
else 
...
------------------------------------------------------------------------
if text == 'رجلي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'VAMBAIR:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'منخيري' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'VAMBAIR:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'VAMBAIR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."VAMBAIR:Spam:Group"..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,taha,success) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
