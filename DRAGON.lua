...
if text == 'العاب متطوره' or text == 'العاب العزايزي' or text == 'الالعاب المتطوره' or text == 'العاب السورس' then
local Text =[[
𝘨𝘢𝘮𝘦𝘴 𝘱𝘳𝘰 ○'
...
{
{text = 'مطور السـورس', url="t.me/alazizy"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'الـمـطـور', url="t.me/"..sudos.UserName}},} 
local function getpro(extra, result, success) 
if result.photos_[0] then 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo='..result.photos_[0].sizes_[1].photo_.persistent_id_..'&caption=' .. URL.escape(Namebot).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
...
if text == "شو رائيك" or text == "اي رائيك" or text == "رد يابوت" then
