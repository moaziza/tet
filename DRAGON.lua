...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/UU_Le2)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/UU_Le2)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/UU_Le2)') 
return false
end
