...
local DRAGON_Msg = { 
'مرحبا بيك في سورس  '..Namebot..' الاعظم..💘', 
} 
Namebot = DRAGON_Msg[math.random(#DRAGON_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'مطور السورس', url="http://t.me/"..result.username}},} 
...
local DRAGON_Msg = { 
'◉ مرحبا انا بوت اسمي '..Namebot..' اختصاصي plp المجموعات من التخريب والتفليش الخ.. قم باضفاتي الي مجموعتك الان..🙂💘',
} 
Namebot = DRAGON_Msg[math.random(#DRAGON_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
