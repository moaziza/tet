...
DevRio:del(TrOn..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local TrOnTeAm = '⋆ اهلا عزيزي ⤌ '..RioRank(msg)..' \n⋆ تم تعطيل الزخرفه بنجاح'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TrOnTeAm, 14, string.len(msg.sender_user_id_))
DevRio:set(TrOn..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(TrOn..'Zrf:Rio'..msg.chat_id_..''..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '⋆ تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(TrOn..'Zrf:Rio'..msg.chat_id_..''..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(TrOn..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'زخرف' and ChCheck(msg) then  
DevRio:setex(TrOn.."Zrf:Rio"..msg.chat_id_..""..msg.sender_user_id_,300,true)
