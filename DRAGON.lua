...
if not DevQue:get(DRAGON..'Que:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = DRAGON,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(DRAGON) then 
if DevQue:sismember(DRAGON..'Que:Groups',msg.chat_id_) then
BotText = "مفعله في السابق\n⌁ارسل ↫ الاوامر واستمتع بالمميزيات"
else 
BotText = "معطله يجب رفعي مشرف\n⌁بعد ذلك يرجى ارسال امر ↫ تفعيل\n⌁سيتم رفع الادمنيه والمنشئ تلقائيا"
end 
local QueText = (DevQue:get(DRAGON.."Que:Text:BotWelcome") or "⌁مرحبا انا بوت اسمي "..NameBot.."\n⌁حالة المجموعه ↫ "..BotText.."\n-----")
local QuePhoto = (DevQue:get(DRAGON.."Que:Photo:BotWelcome") or abbas.photos_[0].sizes_[1].photo_.persistent_id_)
if DevQue:get(DRAGON.."Que:Photo:BotWelcome") or abbas.photos_[0] then
sendPhoto(msg.chat_id_,msg.id_,0,1,nil,QuePhoto,QueText)
else 
send(msg.chat_id_,msg.id_,QueText)
end 
end   
end
end,nil)
end
if DevQue:get(DRAGON..'Que:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙴𝙻𝙰𝙻𝙰𝙼𝚈 ',url="t.me/alazizy"}},
...
if text == 'اسلام حداد' or text == 'مطور السورس' or text == 'حداد' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝚁𝙾𝚁𝙾 ◉',url="t.me/Taraaroro"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
