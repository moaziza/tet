...
sudo_users = {SUDO,1183747742,1492525660,1844327092}   
...
{{text = '𝙳𝙴𝚅 𝙴𝚂𝚂𝙻𝙰𝙼 ',url="t.me/Ess_lam"}},
...
if text == 'اسلام حداد' or text == 'صاحبه السورس' or text == 'حداد' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/877 &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'رورو' or text == 'صاحبه السورس' or text == 'تارا' then
local Text = [[
◉ ست البنات..🐼♥️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝚁𝙾𝚁𝙾 ◉',url="t.me/alazizy"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/878&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if tonumber(result.sender_user_id_) == tonumber(1492525660) then  
...
if result.id_ == tonumber(1492525660) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مالك السورس\n")
return false 
end
if result.id_ == tonumber(1844327092) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر صاحبه السورس \n")
return false 
end
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'BANDA1M')..')'
status  = '\n ◉ تم حظره عام من {'..Groups..'} مجموعه'
...
if tonumber(userid) == tonumber(1492525660) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مالك السورس عام")
return false 
end
...
if result.id_ == tonumber(1492525660) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك كتم صاحبه السورس \n")
return false 
end
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'BANDA1M')..')'
status  = '\n ◉ تم كتمه عام من {'..Groups..'} مجموعه'
