...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/moaziza/moaz/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/moaziza/moaz/main/DRAGON.lua')
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/moaziza/moaz/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/moaziza/moaz/main/library')
os.execute('wget https://raw.githubusercontent.com/moaziza/moaz/main/File_Bot')
send(msg.chat_id_, msg.id_,' ⋆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
[𝐖𝐄𝐋𝐂𝐎𝐌 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄](t.me/belalelshayals)
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/moaziza/moaz/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/moaziza/moaz/main/File_Bot/"..file)
if res == 200 then
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'دندشه') 
local DRAGON_Msg = { 
'⋆ اسمي القميل '..Namebot..' 🥺💘',
} 
