...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/moaziza/tettty/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/moaziza/tettty/main/DRAGON.lua')
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/moaziza/tettty/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/moaziza/tettty/main/library')
os.execute('wget https://raw.githubusercontent.com/moaziza/tettty/main/File_Bot')
send(msg.chat_id_, msg.id_,' ⋆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text =='تغيير المطور' and spiderDevSou(msg) then
send(msg.chat_id_, msg.id_,'⋆ ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='☢️ - تغيير المطور الاساسي' and not spiderDevSou(msg) then
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/moaziza/tettty/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/moaziza/tettty/main/File_Bot/"..file)
if res == 200 then
